...
import { useDiscoAudio } from "@/hooks/use-disco-audio";

export function DiscoMute() {
  ...
  if (!available) {
    return (
      <span className="hidden md:inline-flex items-center px-2 h-11 border-4 border-ink bg-cream text-ink text-xs font-display">
        🔇 NO AUDIO FILE
      </span>
    );
  }
