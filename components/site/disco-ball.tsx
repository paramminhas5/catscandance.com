...
export function DiscoBall() {
  ...
  useEffect(() => {
    ...
    middle.style.cssText = `
      width:100%;height:100%;border-radius:100%;position:absolute;inset:0;
  ...
  return (
    <motion.div
      initial={reduce ? { opacity: 1 } : { y: -400, opacity: 0 }}
    ...
    >
      ...
      <div
        className="relative"
        style={{ width: 100, height: 100, margin: "0 auto", perspective: 800 }}
      >
        <div
